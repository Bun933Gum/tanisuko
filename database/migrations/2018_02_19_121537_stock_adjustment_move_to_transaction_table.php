...
class StockAdjustmentMoveToTransactionTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('stock_adjustment_lines', function (Blueprint $table) {
            ...
            ->onDelete('cascade');
            $table->decimal('quantity', 22, 0);
            $table->decimal('unit_price', 22, 0)->comment("Last purchase unit price")->nullable();
            $table->timestamps();
        ...
        Schema::table('transactions', function (Blueprint $table) {
            ...
            $table->decimal('total_amount_recovered', 22, 0)->comment("Used for stock adjustment.")->nullable()->after('exchange_rate');
        });
