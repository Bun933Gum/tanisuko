...
class AddAdditionalExpenseColumnsToTransactionTable extends Migration
{
    ...
    public function up()
    {
        Schema::table('transactions', function (Blueprint $table) {
            ...
            $table->decimal('additional_expense_value_1', 22, 0)->default(0)->after('additional_expense_key_1');

            $table->string('additional_expense_key_2')->nullable()->after('additional_expense_value_1');
            $table->decimal('additional_expense_value_2', 22, 0)->default(0)->after('additional_expense_key_2');

            $table->string('additional_expense_key_3')->nullable()->after('additional_expense_value_2');
            $table->decimal('additional_expense_value_3', 22, 0)->default(0)->after('additional_expense_key_3');

            $table->string('additional_expense_key_4')->nullable()->after('additional_expense_value_3');
            $table->decimal('additional_expense_value_4', 22, 0)->default(0)->after('additional_expense_key_4');
        });
    }
